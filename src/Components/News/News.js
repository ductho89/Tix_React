    ...
    <div id="tinTuc" className="bg container">
      ...
      <div className="tab-content" id="myTabContent">
        <div
          ...
          id="home"
          role="tabpanel"
          aria-labelledby="dienAnh24h"
        >
          <div className="row dienAnh24h__news">
            <div className="col-sm-6 news__left">
              <a href>
                <img
                  src="./img/khai-truong-rap-xin-gia-ngon-chuan-xi-tai-sai-gon-16111317082644.jpg"
                  alt
                  className="img-fluid"
                />
              </a>
        ...
        >
          <div className="row dienAnh24h__news">
            ...
            <div className="col-sm-6 news__right">
              <a href>
                <img src="./img/2.png" alt className="img-fluid" />
              </a>
              <a href>
          ...
          <div className="row list__news">
            <div className="col-sm-4 news">
              <a href>
                <img src="./img/3.png" alt className="img-fluid" />
              </a>
              <a className="title" href>
                <h4>‘BlacKkKlansman’ - cốc nước lạnh để người Mỹ thức tỉnh</h4>
              </a>
              <p className="p__text">
        ...
        >
          <div className="row dienAnh24h__news">
            <div className="col-sm-6 news__left">
              <a href>
                <img src="./img/9.jpg" alt className="img-fluid" />
              </a>
              <a href>
            ...
            <div className="col-sm-6 news__right">
              <a href>
                <img src="./img/10.jpg" alt className="img-fluid" />
              </a>
              <a href>
          ...
          <div className="row list__news">
            <div className="col-sm-4 news">
              <a href>
                <img src="./img/11.png" alt className="img-fluid" />
              </a>
              <a className="title" href>
